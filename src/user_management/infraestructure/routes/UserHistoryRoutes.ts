...
export function setupUserHistoryRoutes(app: Express) {
    app.post(`${BASE_URL}${MODEL_URL}create`, createUserHistoryController.execute.bind(createUserHistoryController));
    app.delete(`${BASE_URL}${MODEL_URL}user/:uuid`, deleteUserHistoryByUserUUIDController.execute.bind(deleteUserHistoryByUserUUIDController));
